...
int Kvaser::canInit(int channel_number)
{
	...
	if (handle < 0)
	{
		cout<<"Failed to open CAN channel"<<endl;
		return EXIT_FAILURE;
	}
	// 设置CAN波特率
	...
	{
		cout << "Failed to SetBUusParams" << endl;
		return EXIT_FAILURE;
	}
	// 打开 can 总线
	...
	{
		cout << "Failed to Start Bus on channels" << endl;
		return EXIT_FAILURE;
	}
...
int Kvaser::connectMotor(long can_id)
{
	...
	// Sleep(100);
	cout << "Motor %d has been connected! \n" << can_id << endl;
	return EXIT_SUCCESS;
}
...
int Kvaser::motorDisable(long can_id)
{
	...
	if (flag == EXIT_FAILURE)
	{
		cout << "Motor %d disabled failed!" << can_id << endl;
		return EXIT_FAILURE;
	}
	cout << "Motor %d has been disabled! " << can_id << endl;
	return EXIT_SUCCESS;
}
...
int Kvaser::modeChoose(long can_id, Mode mode)
{
	...
	if (flag == EXIT_FAILURE)
	{
		cout << "Motor %d choose mode failed! " << can_id << endl;
	}
	motorEnable(can_id);
	//Sleep(100); // need more time
	cout << "Motor %d mode has been chosen! " << can_id << endl;
	return EXIT_SUCCESS;
}
...
int Kvaser::speedMode(long can_id, int32_t speed)
{
	...
	if (flag == EXIT_FAILURE)
	{
		cout << "Motor %d start speed mode failed! " << can_id << endl;
		return EXIT_FAILURE;
	}
	//Sleep(100);
	beginMovement(can_id);
	cout << "Motor %d start speed mode! " << can_id << endl;
	return EXIT_SUCCESS;
}
...
int Kvaser::torqueMode(long can_id, float torque)
{
	...
	if (flag == EXIT_FAILURE)
	{
		cout << "Motor %d start torque failed! \n" << can_id << endl;
		return EXIT_FAILURE;
	}
...
int Kvaser::beginMovement(long can_id)
{
	...
	if (flag == EXIT_FAILURE)
	{
		cout << "Motor %d begin move! failed! \n" << can_id << endl;
		return EXIT_FAILURE;
	}
	cout << "Motor %d begin move!" << can_id << endl;
	return EXIT_SUCCESS;
}
